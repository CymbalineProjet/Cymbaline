...
<head>
    <head>
        ...
        <title>Edmin</title>
        <link type="text/css" href="<?php $view->front('bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet">
        <link type="text/css" href="<?php $view->front('bootstrap/css/bootstrap-responsive.min.css'); ?>" rel="stylesheet">
        <link type="text/css" href="<?php $view->front('css/theme.css'); ?>" rel="stylesheet">
                    ...
                    <ul class="nav pull-right">
                        ...
                        <li class="nav-user dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php $view->front('images/user.png'); ?>" class="nav-avatar" />
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
