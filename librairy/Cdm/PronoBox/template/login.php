<?php $view->extend("head", "prono14 | Access"); //toujours etendre le header //on peut par la suite etendre un menu, un widget, un module, etc ... //$view->get("User/SecurityBox/login"); ?>
<div class="main-container">
    ...
    <div class="main">
        <header>
            ...
            <?php } else { ?>
            <h3>
                <?php echo $view->variables['retour'];?></h3>
            <?php } ?>
        </header>
        <div id="scrollbar1">
            <div class="scrollbar">
