...
/**
 * Description of ModeleFileService
 *
 * @author Thibault
 */
class ModeleFileService extends ModeleFile {
    ...
    public function load() {
        $this->modele = file_get_contents(__DIR__."/../template/modele/modele-service.txt");
    }
    ...
    public function save() {
        $file = new File();
        $file->ecrire($this->modele, __DIR__.'/../../../../source/'.$this->attributs->path.'/service/'.$this->attributs->name.'Service.php');
    }
